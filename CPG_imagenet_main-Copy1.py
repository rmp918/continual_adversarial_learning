...
from utils.manager_Copy1 import Manager
...
def main():
    ...
    manager = Manager(args, model, shared_layer_info, masks, train_loader, val_loader, begin_prune_step, end_prune_step, args.adv_train, attack)
